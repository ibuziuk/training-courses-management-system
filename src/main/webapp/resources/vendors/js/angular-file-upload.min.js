...
!function (e, t) {
	...
	return function (e) {
		...
		}, i = r(n(2)), o = r(n(3)), s = r(n(4)), a = r(n(5)), u = r(n(6)), l = r(n(7)), c = r(n(1)), f = r(n(8)), p = r(n(9)), d = r(n(10)), h = r(n(11)), v = r(n(12));
		...
		function r(e) {
			var t = function (e) {
				function t(e) {
					u(this, t), this.events = {
						$destroy: "destroy",
						change: "onChange"
					}, this.prop = "select", s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e), this.uploader.isHTML5 || this.element.removeAttr("multiple"), this.element.prop("value", null)
				}
		...
		"use strict";
		function r(e, t, n, r, i, v) {
			var m = r.File, _ = r.FormData, g = function () {
				function r(t) {
					s(this, r);
					var n = a(e);
					u(this, n, t, {
				...
				return o(r, {
					addToQueue: {
						value: function (e, t, n) {
							var r = this.isArrayLikeObject(e) ? e : [e], o = this._getFilters(n), s = this.queue.length, a = [];
							l(r, function (e) {
								var n = new i(e);
								if (this._isValidFile(n, o, t)) {
									var r = new v(this, e, t);
									a.push(r), this.queue.push(r), this._onAfterAddingFile(r)
								} else {
									var s = o[this._failFilterIndex];
									this._onWhenAddingFileFailed(n, s, t)
								}
						...
						value: function () {
							l(this._directives, function (e) {
								l(this._directives[e], function (e) {
									e.destroy()
								}, this)
							}, this)
						}
						...
						value: function (e, t) {
							...
							return l(n.defaults.transformResponse, function (t) {
								e = t(e, r)
							}), e
						}
					}, _parseHeaders: {
						...
						value: function (e) {
							var t = e._xhr = new XMLHttpRequest, n = new _, r = this;
							if (r._onBeforeUploadItem(e), l(e.formData, function (e) {
										l(e, function (e, t) {
											n.append(t, e)
										})
									}), "number" != typeof e._file.size)throw new TypeError("The file specified is no longer valid");
							n.append(e.alias, e._file, e.file.name), t.upload.onprogress = function (t) {
								var n = Math.round(t.lengthComputable ? 100 * t.loaded / t.total : 0);
								r._onProgressItem(e, n)
							}, t.onload = function () {
								var n = r._parseHeaders(t.getAllResponseHeaders()), i = r._transformResponse(t.response, n), o = r._isSuccessCode(t.status) ? "Success" : "Error", s = "_on" + o + "Item";
								r[s](e, i, t.status, n), r._onCompleteItem(e, i, t.status, n)
							}, t.onerror = function () {
								var n = r._parseHeaders(t.getAllResponseHeaders()), i = r._transformResponse(t.response, n);
								r._onErrorItem(e, i, t.status, n), r._onCompleteItem(e, i, t.status, n)
							}, t.onabort = function () {
								var n = r._parseHeaders(t.getAllResponseHeaders()), i = r._transformResponse(t.response, n);
								r._onCancelItem(e, i, t.status, n), r._onCompleteItem(e, i, t.status, n)
							}, t.open(e.method, e.url, !0), t.withCredentials = e.withCredentials, l(e.headers, function (e, n) {
								t.setRequestHeader(n, e)
							}), t.send(n), this._render()
						}
					}, _iframeTransport: {
						value: function (e) {
							var t = h('<form style="display: none;" />'), n = h('<iframe name="iframeTransport' + Date.now() + '">'), r = e._input, i = this;
							e._form && e._form.replaceWith(r), e._form = t, i._onBeforeUploadItem(e), r.prop("name", e.alias), l(e.formData, function (e) {
								l(e, function (e, n) {
									var r = r('<input type="hidden" name="' + n + '" />');
									r.val(e), t.append(r)
								})
							}), t.prop({
								action: e.url,
								...
								var t = "", r = 200;
								try {
									t = n[0].contentDocument.body.innerHTML
								} catch (o) {
									r = 500
								}
								var s = {
									...
									status: r,
									dummy: !0
								}, a = {}, u = i._transformResponse(s.response, a);
								i._onSuccessItem(e, u, s.status, a), i._onCompleteItem(e, u, s.status, a)
							}), t.abort = function () {
								var o, s = {status: 0, dummy: !0}, a = {};
								n.unbind("load").prop("src", "javascript:false;"), t.replaceWith(r), i._onCancelItem(e, o, s.status, a), i._onCompleteItem(e, o, s.status, a)
							}, r.after(t), t.append(r).append(n), t[0].submit(), this._render()
						}
						...
						value: function (e, t, n, r) {
							...
							return this.isUploading = !1, p(i) ? void i.upload() : (this.onCompleteAll(), this.progress = this._getTotalProgress(), void this._render())
						}
					}
				}, {
					isFile: {
						...
						value: function (e) {
							return e instanceof this.constructor.FileLikeObject
						}
					}, isArrayLikeObject: {
						value: function (e) {
			...
			return g.prototype.isHTML5 = !(!m || !_), g.isHTML5 = g.prototype.isHTML5, g
		}
		...
		e.exports = r;
		var a = (i(n(2)), angular.copy), u = angular.extend, l = angular.forEach, c = angular.isObject, f = angular.isNumber, p = angular.isDefined, d = angular.isArray, h = angular.element;
		r.$inject = ["fileUploaderOptions", "$rootScope", "$http", "$window", "FileLikeObject", "FileItem"]
	}, function (e, t, n) {
		"use strict";
		function r() {
			var e = function () {
				function e(t) {
					s(this, e);
					var n = u(t), r = n ? t.value : t, i = l(r) ? "FakePath" : "Object", o = "_createFrom" + i;
					this[o](r)
				}
				...
				return o(e, {
					_createFromFakePath: {
						...
						value: function (e) {
							this.lastModifiedDate = a(e.lastModifiedDate), this.size = e.size, this.type = e.type, this.name = e.name
						}
					}
				}), e
			}();
		...
		e.exports = r;
		var a = (i(n(2)), angular.copy), u = angular.isElement, l = angular.isString;
		r.$inject = []
	}, function (e, t, n) {
		"use strict";
		function r(e, t) {
			var n = function () {
				function n(e, r, i) {
					s(this, n);
					var o = c(r), f = o ? l(r) : null, p = o ? null : r;
					u(this, {
						url: e.url,
						alias: e.alias,
						headers: a(e.headers),
		...
		e.exports = r;
		var a = (i(n(2)), angular.copy), u = angular.extend, l = angular.element, c = angular.isElement;
		...
		function r() {
			var e = function () {
				function e(t) {
					s(this, e), a(this, t), this.uploader._directives[this.prop].push(this), this._saveLinks(), this.bind()
				}
		...
		function r(e) {
			var t = function (e) {
				function t(e) {
					...
					}, this.prop = "drop", s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e)
				}
		...
		function r(e) {
			var t = function (e) {
				function t(e) {
					u(this, t), this.events = {$destroy: "destroy"}, this.prop = "over", this.overClass = "nv-file-over", s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e)
				}
			...
			return {
				link: function (n, r, i) {
					...
					s.getOverClass = function () {
						return i.overClass || this.overClass
					}
				}
			}
		}
